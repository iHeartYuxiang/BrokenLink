...
import com.iheart.selenium.brokenLink.*;

@RunWith(Parameterized.class)



public class TestLocalDesktop {
	...
	public TestLocalDesktop(String url) {
		this.url = url;
	...
	public void setUp() throws Exception {
		...
		*/
		 System.out.println("See url:" + url);
	...
	@Test
	 ...
	 {   
	 	...
	 	try{
	 		...
	 		checkBroken.goThroughLinks("LocalDeskTop");
	 	}catch(Exception e)
	 	{
	 		e.printStackTrace();
